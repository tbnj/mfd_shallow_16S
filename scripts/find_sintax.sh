...
find $DIR_IN -type f -name 'arc_bac*_reverse_MFG_ssu_database_NR987_trunc.sintax' -exec ln -s '{}' $DIR_OUT_R ';'

# Find results for EUK
find $DIR_IN -type f -name 'euk*_forward_MFG_ssu_database_NR987_trunc.sintax' -exec ln -s '{}' $DIR_OUT_F ';'
find $DIR_IN -type f -name 'euk*_reverse_MFG_ssu_database_NR987_trunc.sintax' -exec ln -s '{}' $DIR_OUT_R ';'